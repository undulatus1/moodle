...
class theme_decaf_core_renderer extends core_renderer {
   ...
   /**Max's Custom
    ...
    public function heading($text, $level = 1, $classes = 'main', $id = null) {
	$content =  "<div class = 'headingcontainer'><img  src='http://localhost/max24/theme/decaf/pix/headingpic' class=>'headingimage'</img>";
...
public function heading($text, $level = 2, $classes = 'main', $id = null) {
    ...
    $content .= html_writer::empty_tag('img', array('src'=>$this->pix_url('headingpic', 'theme'), 'alt'=>'', 'class'=>'headingimage', 'style'=>'float: left'));
    $content .= parent::heading($text, $level, $classes, $id);
